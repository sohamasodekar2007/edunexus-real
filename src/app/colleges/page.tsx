...
const mockColleges: College[] = [
  // Mumbai Region
  { id: '3012', name: 'Veermata Jijabai Technological Institute (VJTI)', district: 'Mumbai City', stream: 'PCM', establishedYear: 1887, collegeType: 'Autonomous', annualFees: '₹85,000', campusSizeAcres: 16, rating: 4.7, logoPlaceholder: getInitials('Veermata Jijabai Technological Institute'), website: 'https://vjti.ac.in' },
  { id: '3014', name: 'Sardar Patel College of Engineering, Andheri', district: 'Mumbai Suburban', stream: 'PCM', establishedYear: 1962, collegeType: 'Autonomous', annualFees: '₹90,000', campusSizeAcres: 40, rating: 4.6, logoPlaceholder: getInitials('Sardar Patel College of Engineering'), website: 'https://www.spit.ac.in' },
  ...
  { id: '3215', name: 'Sardar Patel Institute of Technology (SPIT), Mumbai', district: 'Mumbai Suburban', stream: 'PCM', establishedYear: 1995, collegeType: 'Private', annualFees: '₹1,70,000', campusSizeAcres: 5, rating: 4.5, logoPlaceholder: getInitials('Sardar Patel Institute of Technology'), website: 'https://www.spit.ac.in' }, // Institute code from list is 3215
  { id: '3199', name: 'Dwarkadas J. Sanghvi College of Engineering (DJSCE), Mumbai', district: 'Mumbai Suburban', stream: 'PCM', establishedYear: 1994, collegeType: 'Private', annualFees: '₹1,90,000', campusSizeAcres: 5, rating: 4.4, logoPlaceholder: getInitials('Dwarkadas J. Sanghvi College of Engineering'), website: 'https://www.djsce.ac.in' }, // Institute code from list is 3199
  ...
  // Pune Region
  { id: '6006', name: 'College of Engineering, Pune (COEP) Technological University', district: 'Pune', stream: 'PCM', establishedYear: 1854, collegeType: 'University Department', annualFees: '₹90,000', campusSizeAcres: 36, rating: 4.8, logoPlaceholder: getInitials('College of Engineering, Pune'), website: 'https://www.coep.org.in' },
  { id: '6273', name: 'Vishwakarma Institute of Technology (VIT), Pune', district: 'Pune', stream: 'PCM', establishedYear: 1983, collegeType: 'Autonomous', annualFees: '₹1,80,000', campusSizeAcres: 7, rating: 4.3, logoPlaceholder: getInitials('Vishwakarma Institute of Technology'), website: 'https://www.vit.edu' },
  { id: '6271', name: 'Pune Institute of Computer Technology (PICT), Pune', district: 'Pune', stream: 'PCM', establishedYear: 1983, collegeType: 'Private', annualFees: '₹1,30,000', campusSizeAcres: 5, rating: 4.5, logoPlaceholder: getInitials('Pune Institute of Computer Technology'), website: 'https://pict.edu' },
  ...
  { id: '6622', name: 'ISBM College Of Engineering Pune', district: 'Pune', stream: 'PCM', establishedYear: 2010, collegeType: 'Private', annualFees: '₹1,20,000', campusSizeAcres: 8, rating: 3.7, logoPlaceholder: getInitials('ISBM COE'), website: '#' },
  ...
  { id: '6757', name: 'Yashoda Technical Campus, Wadhe, Satara.', district: 'Satara', stream: 'PCM', establishedYear: 2011, collegeType: 'Private', annualFees: '₹90,000', campusSizeAcres: 10, rating: 3.8, logoPlaceholder: getInitials('YTC Satara'), website: '#' }, // Re-added from previous list
  ...
  { id: '6795', name: 'Shri.Someshwar Shikshan Prasarak Mandal, Sharadchandra Pawar College of Engineering & Technology, Someshwar Nagar', district: 'Pune', stream: 'PCM', establishedYear: 2012, collegeType: 'Private', annualFees: '₹1,00,000', campusSizeAcres: 10, rating: 3.7, logoPlaceholder: getInitials('SSSPM SPCOET'), website: '#' },
  ...
  { id: '5161', name: 'Dr. Vithalrao Vikhe Patil College of Engineering, AhilyaNagar', district: 'AhilyaNagar', stream: 'PCM', establishedYear: 1983, collegeType: 'Private', annualFees: '₹1,20,000', campusSizeAcres: 20, rating: 4.0, logoPlaceholder: getInitials('Dr. Vithalrao Vikhe Patil'), website: '#' },
  { id: '5409', name: 'Rajiv Gandhi College of Engineering & Polytechnic, AhilyaNagar', district: 'AhilyaNagar', stream: 'PCM', establishedYear: 2009, collegeType: 'Private', annualFees: '₹90,000', campusSizeAcres: 15, rating: 3.8, logoPlaceholder: getInitials('Rajiv Gandhi College AhilyaNagar'), website: '#' },
  { id: '5139', name: 'Pravara Rural Engineering College, Loni', district: 'AhilyaNagar', stream: 'PCM', establishedYear: 1983, collegeType: 'Private', annualFees: '₹1,10,000', campusSizeAcres: 25, rating: 4.1, logoPlaceholder: getInitials('Pravara Rural Engineering'), website: '#' },
  { id: '5382', name: 'Shri Chhatrapati Shivaji Maharaj College of Engineering, Nepti', district: 'AhilyaNagar', stream: 'PCM', establishedYear: 2009, collegeType: 'Private', annualFees: '₹85,000', campusSizeAcres: 10, rating: 3.7, logoPlaceholder: getInitials('SCSMCE Nepti'), website: '#' },
  { id: '5380', name: 'Adsul Technical Campus Faculty of Engineering & MBA, AhilyaNagar', district: 'AhilyaNagar', stream: 'PCM', establishedYear: 2011, collegeType: 'Private', annualFees: '₹75,000', campusSizeAcres: 12, rating: 3.6, logoPlaceholder: getInitials('Adsul Technical Campus'), website: '#' },
  { id: '19', name: 'Shri Sant Gadge Baba College of Engineering and Technology, AhilyaNagar', district: 'AhilyaNagar', stream: 'PCM', establishedYear: 2008, collegeType: 'Private', annualFees: '₹95,000', campusSizeAcres: 18, rating: 3.9, logoPlaceholder: getInitials('SSGBCE AhilyaNagar'), website: '#' },
  { id: '5408', name: 'Vidya Niketan College of Engineering, Sangamner', district: 'AhilyaNagar', stream: 'PCM', establishedYear: 2011, collegeType: 'Private', annualFees: '₹70,000', campusSizeAcres: 8, rating: 3.5, logoPlaceholder: getInitials('Vidya Niketan Sangamner'), website: '#' },
  { id: '5303', name: "Hon. Shri Babanrao Pachpute Vichardhara Trust's Faculty of Engineering, AhilyaNagar", district: 'AhilyaNagar', stream: 'PCM', establishedYear: 2006, collegeType: 'Private', annualFees: '₹1,00,000', campusSizeAcres: 22, rating: 4.0, logoPlaceholder: getInitials('Babanrao Pachpute Trust'), website: '#' },
  ...
  { id: '5179', name: "Vishwabharati Academy's College of Engineering, AhilyaNagar", district: 'AhilyaNagar', stream: 'PCM', establishedYear: 2006, collegeType: 'Private', annualFees: '₹1,05,000', campusSizeAcres: 19, rating: 3.9, logoPlaceholder: getInitials('Vishwabharati Academy'), website: '#' },
  ...
  { id: '5160', name: 'Sanjivani College of Engineering, Kopargaon', district: 'AhilyaNagar', stream: 'PCM', establishedYear: 1983, collegeType: 'Private', annualFees: '₹1,25,000', campusSizeAcres: 28, rating: 4.4, logoPlaceholder: getInitials('Sanjivani Kopargaon'), website: '#' },
  { id: '5162', name: 'Amrutvahini College of Engineering, Sangamner', district: 'AhilyaNagar', stream: 'PCM', establishedYear: 1983, collegeType: 'Private', annualFees: '₹1,15,000', campusSizeAcres: 26, rating: 4.3, logoPlaceholder: getInitials('Amrutvahini Sangamner'), website: '#' },

  // Akola
  { id: '1116', name: "Shri Shivaji Education Society's College of Engineering and Technology, Akola", district: 'Akola', stream: 'PCM', establishedYear: 1983, collegeType: 'Private', annualFees: '₹90,000', campusSizeAcres: 25, rating: 4.1, logoPlaceholder: getInitials('SSESCOET Akola'), website: '#' },
  ...
  { id: '1276', name: "Manav School of Engineering & Technology, Gut No. 1035 Nagpur Surat Highway, NH No. 6 Tal.Vyala, Balapur, Akola, 444302", district: 'Akola', stream: 'PCM', establishedYear: 2011, collegeType: 'Private', annualFees: '₹70,000', campusSizeAcres: 10, rating: 3.7, logoPlaceholder: getInitials('Manav School Akola'), website: '#' },
  ...
  { id: '1128', name: 'Prof Ram Meghe College of Engineering and Management, Badnera', district: 'Amravati', stream: 'PCM', establishedYear: 2009, collegeType: 'Private', annualFees: '₹1,00,000', campusSizeAcres: 15, rating: 4.0, logoPlaceholder: getInitials('PRMCEAM Badnera'), website: '#' },
  { id: '451', name: 'DESs College of Engineering and Technology, Amravati', district: 'Amravati', stream: 'PCM', establishedYear: 2009, collegeType: 'Private', annualFees: '₹75,000', campusSizeAcres: 8, rating: 3.7, logoPlaceholder: getInitials("DES College Amravati"), website: '#' },
  { id: '461', name: 'IBSS College of Engineering, Amravati', district: 'Amravati', stream: 'PCM', establishedYear: 2009, collegeType: 'Private', annualFees: '₹70,000', campusSizeAcres: 7, rating: 3.6, logoPlaceholder: getInitials("IBSS College"), website: '#' },
  { id: '421', name: 'G. H. Raisoni College of Engineering and Management, Amravati', district: 'Amravati', stream: 'PCM', establishedYear: 2008, collegeType: 'Private', annualFees: '₹1,20,000', campusSizeAcres: 18, rating: 4.0, logoPlaceholder: getInitials("G H Raisoni Amravati"), website: '#' },
  ...
  { id: '5124', name: 'Jagadamba Education Soc. Nashiks S.N.D. College of Engineering & Reserch, Babulgaon', district: 'Yavatmal', stream: 'PCM', establishedYear: 2006, collegeType: 'Private', annualFees: '₹90,000', campusSizeAcres: 10, rating: 3.9, logoPlaceholder: getInitials('SND Babulgaon'), website: '#' },

  // Buldhana
  { id: '1101', name: 'Shri Sant Gajanan Maharaj College of Engineering,Shegaon', district: 'Buldhana', stream: 'PCM', establishedYear: 1983, collegeType: 'Private', annualFees: '₹1,20,000', campusSizeAcres: 75, rating: 4.6, logoPlaceholder: getInitials('SSGMCE Shegaon'), website: '#' },
  { id: '1119', name: 'Paramhansa Ramkrishna Maunibaba Shikshan Santhas , Anuradha Engineering College, Chikhali', district: 'Buldhana', stream: 'PCM', establishedYear: 1993, collegeType: 'Private', annualFees: '₹85,000', campusSizeAcres: 20, rating: 3.9, logoPlaceholder: getInitials('Anuradha EC Chikhali'), website: '#' },
  ...
  { id: '1130', name: 'Vision Buldhana Educational & Welfare Societys Pankaj Laddhad Institute of Technology & Management Studies, Yelgaon', district: 'Buldhana', stream: 'PCM', establishedYear: 2010, collegeType: 'Private', annualFees: '₹70,000', campusSizeAcres: 10, rating: 3.6, logoPlaceholder: getInitials('PLITMS Yelgaon'), website: '#' },
  ...
  { id: '651', name: "Babasaheb Naik College of Engineering, Buldhana", district: 'Buldhana', stream: 'PCM', establishedYear: 1983, collegeType: 'Private', annualFees: '₹88,000', campusSizeAcres: 20, rating: 4.0, logoPlaceholder: getInitials("BNCOE Buldhana"), website: '#' },
  ...
  // Osmanabad (Dharashiv)
  { id: '1268', name: 'Siddhivinayak Technical Campus, School of Engineering & Research Technology, Shirasgon, Nile', district: 'Osmanabad', stream: 'PCM', establishedYear: 2011, collegeType: 'Private', annualFees: '₹75,000', campusSizeAcres: 12, rating: 3.6, logoPlaceholder: getInitials('Siddhivinayak Shirasgon'), website: '#' },
  ...
  { id: '2641', name: 'Dr. V.K. Patil College of Engineering & Technology', district: 'Osmanabad', stream: 'PCM', establishedYear: 2011, collegeType: 'Private', annualFees: '₹70,000', campusSizeAcres: 10, rating: 3.6, logoPlaceholder: getInitials('VK Patil Osmanabad'), website: '#' }, // Location for 'Dr. V.K. Patil College of Engineering & Technology' is Osmanabad
  ...
  { id: '1117', name: 'Janata Shikshan Prasarak Mandal', district: 'Chh. Sambhaji Nagar', stream: 'PCM', establishedYear: 1980, collegeType: 'Private', annualFees: '₹70000', campusSizeAcres: 10, rating: 3.5, logoPlaceholder: getInitials('JSPM Unknown'), website: '#' }, // Location unknown, placing in Chh. Sambhaji Nagar as a default from previous context.
  ...
  // Nashik (for Ohar)
  { id: '2111', name: 'Everest Education Society, Group of Institutions (Integrated Campus), Ohar', district: 'Nashik', stream: 'PCM', establishedYear: 2008, collegeType: 'Private', annualFees: '₹70,000', campusSizeAcres: 10, rating: 3.6, logoPlaceholder: getInitials('Everest Ohar'), website: '#' },
  ...
  { id: '3220', name: 'Yadavrao Tasgaonkar College of Engineering & Management', district: 'Raigad', stream: 'PCM', establishedYear: 2005, collegeType: 'Private', annualFees: '₹1,00,000', campusSizeAcres: 15, rating: 3.7, logoPlaceholder: getInitials('YTCOEM'), website: '#' }, // Assuming Karjat (Raigad) as likely location
  ...
  { id: '3423', name: 'Shree L.R. Tiwari College of Engineering, Mira Road, Mumbai', district: 'Thane', stream: 'PCM', establishedYear: 2009, collegeType: 'Private', annualFees: '₹1,30,000', campusSizeAcres: 5, rating: 3.8, logoPlaceholder: getInitials('Shree L.R. Tiwari'), website: '#' },
  ...
  { id: '3465', name: 'Ideal Institute of Technology, Wada, Dist.Thane', district: 'Palghar', stream: 'PCM', establishedYear: 2011, collegeType: 'Private', annualFees: '₹80,000', campusSizeAcres: 8, rating: 3.4, logoPlaceholder: getInitials('Ideal Wada'), website: '#' }, // Wada is Palghar
  ...
  { id: '4133', name: 'Sanmarg Shikshan Sansthas Smt. Radhikatai Pandav College of Engineering, Nagpur', district: 'Nagpur', stream: 'PCM', establishedYear: 1999, collegeType: 'Private', annualFees: '₹95,000', campusSizeAcres: 10, rating: 3.9, logoPlaceholder: getInitials('SRPCE Nagpur'), website: '#' },
  { id: '4134', name: 'Guru Nanak Institute of Engineering & Technology,Kalmeshwar, Nagpur', district: 'Nagpur', stream: 'PCM', establishedYear: 2008, collegeType: 'Private', annualFees: '₹1,00,000', campusSizeAcres: 12, rating: 3.8, logoPlaceholder: getInitials('GNIET Nagpur'), website: '#' },
  { id: '4135', name: 'Amar Seva Mandals Shree Govindrao Vanjari College of Engineering & Technology, Nagpur', district: 'Nagpur', stream: 'PCM', establishedYear: 1997, collegeType: 'Private', annualFees: '₹1,05,000', campusSizeAcres: 10, rating: 3.9, logoPlaceholder: getInitials('ASMSGVCOET Nagpur'), website: '#' },
  { id: '4136', name: 'Lokmanya Tilak Jankalyan Shikshan Sastha, Priyadarshini J. L. College Of Engineering, Nagpur', district: 'Nagpur', stream: 'PCM', establishedYear: 2008, collegeType: 'Private', annualFees: '₹1,00,000', campusSizeAcres: 10, rating: 3.8, logoPlaceholder: getInitials('PJLCE Nagpur'), website: '#' },
  { id: '4138', name: 'Jaidev Education Society, J D College of Engineering and Management, Nagpur', district: 'Nagpur', stream: 'PCM', establishedYear: 2008, collegeType: 'Private', annualFees: '₹1,10,000', campusSizeAcres: 10, rating: 3.9, logoPlaceholder: getInitials('JDCOEM Nagpur'), website: '#' },
  { id: '4139', name: 'Samridhi Sarwajanik Charitable Trust, Jhulelal Institute of Technology, Nagpur', district: 'Nagpur', stream: 'PCM', establishedYear: 2008, collegeType: 'Private', annualFees: '₹95,000', campusSizeAcres: 10, rating: 3.8, logoPlaceholder: getInitials('JIT Nagpur'), website: '#' },
  { id: '4141', name: 'Shriram Gram Vikas Shikshan Sanstha, Vilasrao Deshmukh College of Engineering and Technology, Nagpur', district: 'Nagpur', stream: 'PCM', establishedYear: 2008, collegeType: 'Private', annualFees: '₹90,000', campusSizeAcres: 10, rating: 3.7, logoPlaceholder: getInitials('VDCOET Nagpur'), website: '#' },
  { id: '4142', name: 'Ankush Shikshan Sansthas G. H. Raisoni Institute of Engineering & Technology, Nagpur', district: 'Nagpur', stream: 'PCM', establishedYear: 2008, collegeType: 'Private', annualFees: '₹1,30,000', campusSizeAcres: 15, rating: 4.0, logoPlaceholder: getInitials('GHRIET Nagpur'), website: '#' },
  { id: '4144', name: 'Shri. Sai Shikshan Sanstha, Nagpur Institute of Technology, Nagpur', district: 'Nagpur', stream: 'PCM', establishedYear: 2008, collegeType: 'Private', annualFees: '₹1,15,000', campusSizeAcres: 10, rating: 3.9, logoPlaceholder: getInitials('NIT Nagpur'), website: '#' },
  { id: '4145', name: 'Wainganga College of Engineering and Management, Dongargaon, Nagpur', district: 'Nagpur', stream: 'PCM', establishedYear: 2008, collegeType: 'Private', annualFees: '₹1,00,000', campusSizeAcres: 10, rating: 3.8, logoPlaceholder: getInitials('WCEM Nagpur'), website: '#' },
  { id: '4151', name: 'Vidarbha Bahu-Uddeshiya Shikshan Sansthas Tulshiramji Gaikwad Patil College of Engineering & Technology, Nagpur', district: 'Nagpur', stream: 'PCM', establishedYear: 2008, collegeType: 'Private', annualFees: '₹1,10,000', campusSizeAcres: 12, rating: 3.9, logoPlaceholder: getInitials('TGPCOET Nagpur'), website: '#' },
  { id: '4172', name: 'Anjuman College of Engineering & Technology, Nagpur', district: 'Nagpur', stream: 'PCM', establishedYear: 1999, collegeType: 'Private', annualFees: '₹1,00,000', campusSizeAcres: 10, rating: 3.8, logoPlaceholder: getInitials('ACET Nagpur'), website: '#' },
  { id: '4177', name: 'Priyadarshini Bhagwati College of Engineering, Harpur Nagar, Umred Road,Nagpur', district: 'Nagpur', stream: 'PCM', establishedYear: 2007, collegeType: 'Private', annualFees: '₹90,000', campusSizeAcres: 10, rating: 3.7, logoPlaceholder: getInitials('PBCOE Nagpur'), website: '#' },
  { id: '4181', name: 'Swaminarayan Siddhanta Institute Of Technology, Nagpur', district: 'Nagpur', stream: 'PCM', establishedYear: 2008, collegeType: 'Private', annualFees: '₹90,000', campusSizeAcres: 10, rating: 3.7, logoPlaceholder: getInitials('SSIT Nagpur'), website: '#' },
  { id: '4192', name: 'Maitraya Education Society, Nagarjuna Institute of Engineering Technology & Management, Nagpur', district: 'Nagpur', stream: 'PCM', establishedYear: 2008, collegeType: 'Private', annualFees: '₹90,000', campusSizeAcres: 10, rating: 3.7, logoPlaceholder: getInitials('NIETM Nagpur'), website: '#' },
  { id: '4193', name: 'K.D.M. Education Society, Vidharbha Institute of Technology,Umred Road ,Nagpur', district: 'Nagpur', stream: 'PCM', establishedYear: 2008, collegeType: 'Private', annualFees: '₹1,00,000', campusSizeAcres: 10, rating: 3.8, logoPlaceholder: getInitials('VIT Nagpur (KDM)'), website: '#' },
  { id: '4196', name: 'Gurunanak Educational Societys Gurunanak Institute of Technology, Nagpur', district: 'Nagpur', stream: 'PCM', establishedYear: 2007, collegeType: 'Private', annualFees: '₹1,05,000', campusSizeAcres: 10, rating: 3.9, logoPlaceholder: getInitials('GIT Nagpur'), website: '#' },
  { id: '4285', name: 'V M Institute of Engineering and Technology, Dongargaon, Nagpur', district: 'Nagpur', stream: 'PCM', establishedYear: 2008, collegeType: 'Private', annualFees: '₹90,000', campusSizeAcres: 10, rating: 3.7, logoPlaceholder: getInitials('VMIET Nagpur'), website: '#' },
  { id: '4613', name: 'Suryodaya College of Engineering & Technology, Nagpur', district: 'Nagpur', stream: 'PCM', establishedYear: 2010, collegeType: 'Private', annualFees: '₹95,000', campusSizeAcres: 10, rating: 3.8, logoPlaceholder: getInitials('SCET Nagpur'), website: '#' },
  ...
  { id: 'chandrapur_somayya', name: 'Somayya Institute of Technology, Chandrapur', district: 'Chandrapur', stream: 'PCM', establishedYear: 2000, collegeType: 'Private', annualFees: '₹80000', campusSizeAcres: 10, rating: 3.8, logoPlaceholder: getInitials('Somayya IT'), website: '#' }, // Used new ID
  ...
  { id: '4679', name: 'Karanjekar College of Engineering & Management, Sakoli', district: 'Bhandara', stream: 'PCM', establishedYear: 2010, collegeType: 'Private', annualFees: '₹65,000', campusSizeAcres: 8, rating: 3.6, logoPlaceholder: getInitials('KCOEM Sakoli'), website: '#' },
  ...
  { id: '5152', name: 'G. H. Raisoni Institute of Business Management,Jalgaon', district: 'Jalgaon', stream: 'PCM', establishedYear: 1998, collegeType: 'Private', annualFees: '₹80,000', campusSizeAcres: 5, rating: 3.9, logoPlaceholder: getInitials('GHRIBM Jalgaon'), website: '#' },
  ...
  { id: '5170', name: 'Hindi Seva Mandals Shri Sant Gadgebaba College of Engineering & Technology, Bhusawal', district: 'Jalgaon', stream: 'PCM', establishedYear: 1983, collegeType: 'Private', annualFees: '₹90,000', campusSizeAcres: 20, rating: 4.0, logoPlaceholder: getInitials('SSGBCOET Bhusawal'), website: '#' },
  ...
  { id: 'jalgaon_shrigulabraodeokarpoly', name: "Shri Gulabrao Deokar Polytechnic, Jalgaon", district: 'Jalgaon', stream: 'PCM', establishedYear: 2000, collegeType: 'Private', annualFees: '₹40000', campusSizeAcres: 10, rating: 3.6, logoPlaceholder: getInitials('SGD Poly'), website: '#' },
  ...
  { id: '5172', name: 'R. C. Patel Institute of Technology, Shirpur', district: 'Dhule', stream: 'PCM', establishedYear: 2001, collegeType: 'Autonomous', annualFees: '₹1,30,000', campusSizeAcres: 25, rating: 4.4, logoPlaceholder: getInitials('RCPIT Shirpur'), website: '#' },
  ...
  { id: '6217', name: 'Shri. Balasaheb Mane Shikshan Prasarak Mandals, Ashokrao Mane Group of Institutions', district: 'Sangli', stream: 'PCM', establishedYear: 2009, collegeType: 'Private', annualFees: '₹90,000', campusSizeAcres: 18, rating: 3.9, logoPlaceholder: getInitials('AMGOI Sangli'), website: '#' },
  ...
  // Kolhapur
  { id: '6028', name: 'Department of Technology, Shivaji University, Kolhapur', district: 'Kolhapur', stream: 'PCM', establishedYear: 2006, collegeType: 'University Department', annualFees: '₹70,000', campusSizeAcres: 850, rating: 4.3, logoPlaceholder: getInitials('DOT SUK'), website: '#' },
  { id: '6036', name: 'Government College of Engineering, Kolhapur', district: 'Kolhapur', stream: 'PCM', establishedYear: 2022, collegeType: 'Government', annualFees: '₹20,000', campusSizeAcres: 15, rating: 4.1, logoPlaceholder: getInitials('GCEK Kolhapur'), website: '#' },
  ...
  { id: '6803', name: 'Sant Gajanan Maharaj College of Engineering, Gadhinglaj', district: 'Kolhapur', stream: 'PCM', establishedYear: 2008, collegeType: 'Private', annualFees: '₹80,000', campusSizeAcres: 10, rating: 3.7, logoPlaceholder: getInitials('SGMCE Gadhinglaj'), website: '#' },
  ...
  { id: '6839', name: 'Dr. D Y Patil Pratishthans College of Engineering, Kolhapur', district: 'Kolhapur', stream: 'PCM', establishedYear: 2000, collegeType: 'Private', annualFees: '₹1,00,000', campusSizeAcres: 10, rating: 3.8, logoPlaceholder: getInitials('Dr DYPCOE Kolhapur'), website: '#' },
  { id: '6878', name: 'Dr. A. D. Shinde College Of Engineering, Tal.Gadhinglaj, Kolhapur', district: 'Kolhapur', stream: 'PCM', establishedYear: 2009, collegeType: 'Private', annualFees: '₹85,000', campusSizeAcres: 12, rating: 3.7, logoPlaceholder: getInitials('ADSCOE Gadhinglaj'), website: '#' },
  ...
  // Gadchiroli (Some might be Chandrapur if specific location is in Chandrapur dist)
  ...
  { id: 'gad_gcoec', name: 'Government College of Engineering, Chandrapur', district: 'Gadchiroli', stream: 'PCM', establishedYear: 1996, collegeType: 'Government', annualFees: '₹22,000', campusSizeAcres: 62, rating: 4.3, logoPlaceholder: getInitials('GCE Chandrapur G'), website: '#' }, // Listed under Gadchiroli but is GCOE Chandrapur
  ...
  { id: '901', name: "Mahatma Gandhi Missions College of Engineering, Hingoli Road, Nanded", district: 'Nanded', stream: 'PCM', establishedYear: 1984, collegeType: 'Private', annualFees: '₹95,000', campusSizeAcres: 15, rating: 4.0, logoPlaceholder: getInitials("MGM Nanded"), website: '#' }, // This is in Nanded
