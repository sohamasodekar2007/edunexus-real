...
const mockColleges: College[] = [
  ...
  { id: 'mgm_nanded_hingoli_list', name: "Mahatma Gandhi Missions College of Engineering, Hingoli Road, Nanded", district: 'Nanded', stream: 'PCM', establishedYear: 1984, collegeType: 'Private', annualFees: '₹95,000', campusSizeAcres: 15, rating: 4.0, logoPlaceholder: getInitials("MGM Nanded"), website: '#' },
